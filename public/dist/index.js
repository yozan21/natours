...
})({"2oUAn":[function(require,module,exports,__globalThis) {
...
},{"./login":"7yHem","./mapBox":"k6XpQ","./updateSettings":"l3cGY","./stripe":"10tSC"}],"7yHem":[function(require,module,exports,__globalThis) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"k6XpQ":[function(require,module,exports,__globalThis) {
/* eslint-disable*/ var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const bookTour = async (tourId)=>{
    try {
        const stripe = await (0, _stripeJs.loadStripe)('pk_test_51RlmjzFfBebOXgjepAwBJSQuxaIxa7qospEo57FVxiZsS1UTGB7LyHbm8x4YqcIAlv9vOyKWKm6wGIUJfXA26CKE00AkPmRpdu');
...
var initStripe = function initStripe(maybeStripe, args, startTime) {
    ...
    if (isTestKey && version !== expectedVersion) console.warn("Stripe.js@".concat(version, " was loaded on the page, but @stripe/stripe-js@").concat("7.5.0", " expected Stripe.js@").concat(expectedVersion, ". This may result in unexpected behavior. For more information, see https://docs.stripe.com/sdks/stripejs-versioning"));
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["2oUAn","f2QDv"], "f2QDv", "parcelRequire11c7", {})
